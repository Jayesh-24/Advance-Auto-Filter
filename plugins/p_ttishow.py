...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [
            [
                InlineKeyboardButton(' 📣 Main Channel ⚡ ', url='https://t.me/MoviesWorldBkp')
            ],
            [
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                photo="https://telegra.ph/file/dc2438eb0094b7301f2e0.jpg",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🍿 Update Channel 🍿', url='http://t.me/MoviesWorldBkp') ] ] )
                )
